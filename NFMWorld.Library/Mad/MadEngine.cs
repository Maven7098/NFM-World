...
namespace NFMWorldLibrary
{
    ...
    public class MadEngine
    {
        ...
        public MadEngine(CarStats stat, int im, bool isClientPlayer)
        {
            Stat = stat;
            Im = im;
        ...
        public void Colide(ContO conto, MadEngine othermad, ContO otherconto)
        {
        ...
        private static int GetWheelGround(MadEngine mad, ContO conto, fix64 bottomy)
        {
            int wheelGround;
        ...
        private static fix64 GetBottomY(MadEngine mad, ContO conto)
        {
            fix64 bottomy;
            if (World.IsHyperglidingEnabled)
            {
